...
abstract class DesignPattern {
  ...
  static String persistValue(String key, String value) {
  ...
  static Map<String, dynamic> _readConfigs() {
  ...
  static void _writeConfigs(Map<String, dynamic> configs) {
    File('.js_cli/configs.json').writeAsStringSync(
      json.encode(configs),
    );
  }
